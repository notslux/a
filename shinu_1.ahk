...
TargetOffsetMethod := config.x64dbg.FOV.Mode
TargetOffsetX := 5
TargetOffsetY := 5
PerventAImingupX := 1
PerventAImingupY := 1
...
if (UseTargetOffsets) {
StopX := Floor(coordinatemode(FocusX + TargetOffsetX, Synchronization, A_ScreenWidth, A_ScreenHeight) * (SmoothnessX/SeparatorX) * EmulatorX)
StopY := Floor(coordinatemode(FocusY + TargetOffsetY, Synchronization, A_ScreenWidth, A_ScreenHeight) * (SmoothnessY/SeparatorY) * EmulatorY)
} else {
StopX := Floor(coordinatemode(FocusX, Synchronization, A_ScreenWidth, A_ScreenHeight) * (SmoothnessX/SeparatorX) * EmulatorX)
StopY := Floor(coordinatemode(FocusY, Synchronization, A_ScreenWidth, A_ScreenHeight) * (SmoothnessY/SeparatorY) * EmulatorY)
}
